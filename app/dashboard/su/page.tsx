  ...
  return (
    <>
      ...
      <Tabs defaultValue="bad" className="w-full pt-12">
        ...
        <TabsContent value="bad">{await renderUi("su", "bad")}</TabsContent>
        <TabsContent value="hard">{await renderUi("su", "hard")}</TabsContent>
        <TabsContent value="good">{await renderUi("su", "good")}</TabsContent>
        <TabsContent value="easy">{await renderUi("su", "easy")}</TabsContent>
      </Tabs>
    </>
  );
}
