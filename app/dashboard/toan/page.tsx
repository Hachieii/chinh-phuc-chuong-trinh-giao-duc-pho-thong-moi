  ...
  return (
    <>
      ...
      <Tabs defaultValue="bad" className="w-full pt-12">
        ...
        <TabsContent value="bad">{await renderUi("toan", "bad")}</TabsContent>
        <TabsContent value="hard">{await renderUi("toan", "hard")}</TabsContent>
        <TabsContent value="good">{await renderUi("toan", "good")}</TabsContent>
        <TabsContent value="easy">{await renderUi("toan", "easy")}</TabsContent>
      </Tabs>
    </>
  );
}
