  ...
  return (
    <>
      ...
      <Tabs defaultValue="bad" className="w-full pt-12">
        ...
        <TabsContent value="bad">{await renderUi("ly", "bad")}</TabsContent>
        <TabsContent value="hard">{await renderUi("ly", "hard")}</TabsContent>
        <TabsContent value="good">{await renderUi("ly", "good")}</TabsContent>
        <TabsContent value="easy">{await renderUi("ly", "easy")}</TabsContent>
      </Tabs>
    </>
  );
}
